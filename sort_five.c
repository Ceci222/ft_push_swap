...
void	sort_four(t_stack *stack_a, t_stack *stack_b)
{
	...
	if (first->content < second->content && first->content < third-> content 
		&& first->content < fourth->content && first->content > fifth->content)
	{
		pb(stack_a, stack_b);
	...
	if (second->content < first->content && second->content < third-> content 
		&& second->content < fourth->content && second->content < fifth-> content)
	{
		sa(stack_a);
		pb(stack_a, stack_b);
		sort_four(stack_a, stack_b);
	...
	if (third->content < first->content && third->content < second-> content 
		&& third->content < fourth->content && third->content < fifth->content)
	{
		ra(stack_a);
		ra(stack_a);
		pb(stack_a, stack_b);
